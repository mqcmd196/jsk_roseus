...
foreach(_dep_pkg ${_roseus_all_rosidl_pkgs})
  ...
  # Generate manifest.l (ROS 1 compatibility: roseus.l expects this file)
  file(MAKE_DIRECTORY "${_dep_output_dir}")
  file(WRITE "${_dep_output_dir}/manifest.l"
    ";;\n;; DO NOT EDIT THIS FILE\n;;\n(ros::load-ros-package \"${_dep_pkg}\")\n")
...
# Install current package's own rosidl-generated .l files to share/roseus/ros/<pkg>/
# (The rosidl pipeline generates them but installs to share/<pkg>/eus/<pkg>/,
#  while ros::load-ros-manifest expects share/roseus/ros/<pkg>/)
set(_self_rosidl_dir "${CMAKE_CURRENT_BINARY_DIR}/rosidl_generator_eus/${PROJECT_NAME}")
if(EXISTS "${_self_rosidl_dir}" OR TARGET "${PROJECT_NAME}__rosidl_generator_eus"
   OR TARGET "${PROJECT_NAME}_interfaces__rosidl_generator_eus")
  file(MAKE_DIRECTORY "${_self_rosidl_dir}")
  file(WRITE "${_self_rosidl_dir}/manifest.l"
    ";;\n;; DO NOT EDIT THIS FILE\n;;\n(ros::load-ros-package \"${PROJECT_NAME}\")\n")
  install(
    DIRECTORY "${_self_rosidl_dir}/"
